...
\end{equation}
The numerator of Equation~(\ref{eq:mode_matching_general}) for beams can be written as
\begin{align}
...
\end{multline}
\begin{align}
&=\frac{1}{\left|q_{x1}\right|\left|q_{x2}\right|}\left(\int_{-\infty}^{\infty}\exp\left(\frac{ikx^2}{2q_{x1}^*}\right)\exp\left(\frac{-ikx^2}{2q_{x2}}\right)dx\right) \times \rm{\rm{c.c}}., \nonumber\\
%&=\frac{1}{\left|q_{x1}\right|\left|q_{x2}\right|}\left( \int_{-\infty}^{\infty} \exp\left(\frac{ikx^2}{2q_{x1}^*} -  \frac{-ikx^2}{2q_{x2}}\right) dx \times \rm{\rm{c.c}}.\right),  \nonumber\\
&=\frac{1}{\left|q_{x1}\right|\left|q_{x2}\right|}\left( \int_{-\infty}^{\infty} \exp\left(\frac{ikx^2\left(q_{x2} - q_{x1}^*\right)}{2q_{x1}^*q_{x2}}\right) dx\right) \times \rm{\rm{c.c}}.,
